...
public class MemberController {
	...
	@ResponseBody
	public Map<String, Object> insertMember(@RequestBody Member member, HttpServletResponse response, Model model) {
	...
	@ResponseBody
	public Map<String, Object> selectMemberByNo(@RequestBody Member member, Model model) {
	...
	@ResponseBody
	public Map<String, Object> deleteMember(@RequestBody Member member, Model model) {
		model.addAttribute("no", member.getNo());
